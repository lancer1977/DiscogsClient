...
public class MasterDeserializationTest : DeserializationTest<DiscogsMaster>
{
    ...
    {
        Result.most_recent_release.Should().Be(13111150);
    }

    [Fact]
    public void DeserializeResult_Deserialize_most_recent_release_url()
    {
        Result.most_recent_release_url.Should().Be("https://api.discogs.com/releases/13111150");
    }

    [Fact]
    public void DeserializeResult_Deserialize_num_for_sale()
    {
        Result.num_for_sale.Should().Be(7);
    }

    [Fact]
    public void DeserializeResult_Deserialize_lowest_price()
    {
        Result.lowest_price.Should().Be(13.51m);
    }
