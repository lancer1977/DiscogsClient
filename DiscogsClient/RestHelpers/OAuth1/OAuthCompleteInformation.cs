...
namespace DiscogsClient.RestHelpers.OAuth1
{
    public class OAuthCompleteInformation
    {
        ...
        public OAuthCompleteInformation(OAuthConsumerInformation consumerInformation, string token,
            string tokenSecret) :
            this(consumerInformation, new OAuthTokenInformation(token, tokenSecret))
        {
        }

        public OAuthCompleteInformation(OAuthConsumerInformation consumerInformation,
            OAuthTokenInformation oAuthTokenInformation)
        {
        ...
        {
            return OAuth1Authenticator.ForProtectedResource(ConsumerInformation.ConsumerKey,
                ConsumerInformation.ConsumerSecret,
        ...
        {
            return OAuth1Authenticator.ForAccessToken(ConsumerInformation.ConsumerKey,
                ConsumerInformation.ConsumerSecret, TokenInformation.Token, TokenInformation.TokenSecret, verifier);
        }
    }
}