...
namespace DiscogsClient.Internal
{
    internal class DiscogsWebClient : RestSharpWebClient, IDiscogsWebClient
    {
        ...
        public DiscogsWebClient(OAuthCompleteInformation oAuthCompleteInformation, string userAgent,
            int timeOut = 10000) :
        ...
        public DiscogsWebClient(TokenAuthenticationInformation tokenAuthenticationInformation, string userAgent,
            int timeOut = 10000)
            : base(userAgent, timeOut)
        {
        ...
        protected override string UserAgentFallBack =>
            @"DiscogsClient https://github.com/David-Desmaisons/DiscogsClient";
        ...
        protected override IRestClient Mature(IRestClient client)
        {
            ...
            return new RestClient(options => options.Authenticator = auth);
        }
