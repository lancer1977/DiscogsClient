...
namespace DiscogsClient
{
    public interface IDiscogsDataBaseClient : IDiscogsReleaseRatingClient
    {
        ...
        /// <param name="max">Number maximum of elements. If null return all elements.</param>
        /// <returns>The corresponding releases</returns>
        IObservable<DiscogsArtistRelease> GetArtistRelease(int artistId, DiscogsSortInformation sort = null,
            int? max = null);
        ...
        /// <param name="max">Number maximum of elements. If null return all elements.</param>
        /// <returns>The corresponding releases</returns>
        IEnumerable<DiscogsArtistRelease> GetArtistReleaseAsEnumerable(int artistId, DiscogsSortInformation sort = null,
            int? max = null);
        ...
        Task DownloadImageAsync(DiscogsImage image, Stream copyStream, CancellationToken cancellationToken,
        ...
        /// <param name="copyStream">Stream where image stream will be copied</param>
        /// <param name="type">Type of image to download: thumbnail or normal</param>
        Task DownloadImageAsync(DiscogsImage image, Stream copyStream,
            DiscogsImageFormatType type = DiscogsImageFormatType.Normal);
        ...
        Task<string> SaveImageAsync(DiscogsImage image, string path, string fileName,
