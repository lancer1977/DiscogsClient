...
Generated: `2026-06-23T17:09:48.225355+00:00`
Model lane: `auto`
Preparedness input: `/mnt/data/lancer1977/code/DiscogsClient/.devstudio/runtime/codebase-snapshot/preparedness.json`

- Scope roots: `/mnt/data/lancer1977/code/DiscogsClient`
...
## Top recommendations
- `/mnt/data/lancer1977/code/DiscogsClient` — readiness `78` / priority `60`
  ...
  - Dependency status: `warn`
    - `dotnet` manifests: `DiscogsAuthenticationConsole/DiscogsAuthenticationConsole.csproj, DiscogsClient.Test/DiscogsClient.Test.csproj, DiscogsClient/PolyhydraGames.Discogs.csproj, DiscogsClient/RestHelpers/RestSharpHelper.csproj`
